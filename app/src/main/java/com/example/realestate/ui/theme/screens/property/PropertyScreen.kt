...
import com.example.realestate.ui.theme.intent.BottomNavItem
...
fun PropertyScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(title = { Text(text = "MagicBricks", fontFamily = FontFamily.Cursive, fontSize = 40.sp, color = (darkergrey)) },
                ...
                Column(
                    ...
                    Row {
                        ...
                        Column (modifier = Modifier.padding(start = 20.dp)){
                            ...
                            Row {
                                Icon(imageVector = Icons.Default.Star, contentDescription = "star", tint = darkergrey, modifier = Modifier.size(30.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription = "star", tint = darkergrey, modifier = Modifier.size(30.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription = "star", tint = darkergrey, modifier = Modifier.size(30.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription = "star", tint = darkergrey, modifier = Modifier.size(30.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription = "star", tint = darkergrey, modifier = Modifier.size(30.dp))
                            }
                            Text(text = "54,780 reviews", color = PurpleGrey40)
                            Button(
                                onClick = {
                                    val callIntent= Intent(Intent.ACTION_DIAL)
                                    callIntent.data="tel:0789397699".toUri()
                    ...
                    Button(onClick = {
                        ...
                        smsIntent.data="smsto:0789397699".toUri()
                        smsIntent.putExtra("sms_body","Hello Linet,how was your day?")
                    ...
                    Button(onClick = {
                        ...
                        shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("gathonilinet236@gmail.com"))
